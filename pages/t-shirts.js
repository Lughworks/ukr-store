                ...
                <div class="lg:col-span-7 space-y-6">
                    <div id="preview-stage" class="aspect-[4/5] bg-zinc-900/20 border border-zinc-800 rounded-3xl relative overflow-hidden">
                        <div data-preview="2d" class="absolute inset-0">
                            ...
                            <img src="./images/${folder}/1.jpeg" id="product-base-image" class="absolute inset-0 w-full h-full object-contain z-10 p-12 transition-all duration-500" onerror="this.src='https://via.placeholder.com/800x1000?text=TEE_DATA_MISSING'">
                        ...
                        <div class="absolute bottom-6 left-6 z-30 flex gap-2">
                            ...
                            <button onclick="window.enable3DViewer('t-shirts','default')" class="bg-black/60 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-[9px] font-bold uppercase tracking-widest hover:border-purple-500 transition">
                                3D
                            </button>
                        </div>
                    </div>
                    <div class="flex gap-4 overflow-x-auto pb-2 no-scrollbar">${images.map(img => `<button onclick="document.getElementById('product-base-image').src='./images/${folder}/${img}'"class="w-24 h-24 flex-shrink-0 bg-zinc-900/40 border border-zinc-800 rounded-2xl overflow-hidden hover:border-purple-500 transition-all group"><img src="./images/${folder}/${img}" class="w-full h-full object-cover opacity-50 group-hover:opacity-100 transition-opacity"></button>`).join('')}
                    </div>
